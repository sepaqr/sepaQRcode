/**
 * This is a patched version of qrcode.js that doesn't insert the UTF-8 BOM bytes, because EPC Standard doesn't want that/has its own character set
 * @fileoverview
...
(function () {
	 ...
	 * oQRCode.("http://map.naver.com"); // Re-create the QRCode.
	 *
	 ...
	 */
	QRCodep.prototype.makeCode = function (sText) {
		this._oQRCode = new QRCodeModel(_getTypeNumber(sText, this._htOption.correctLevel), this._htOption.correctLevel);
		this._oQRCode.addData(sText);
		this._oQRCode.make();
		this._el.title = sText;

		if( (this._htOption.dpi != -1) && (this._htOption.mmPerDot != -1)){
			//user provided us with values, so override size one we know the module count
	 ...
	 * @private
	 */
	QRCodep.prototype.makeImage = function () {
	 ...
	 * Clear the QRCode
	 */
	QRCodep.prototype.clear = function () {
	 ...
	 */
	QRCodep.CorrectLevel = QRErrorCorrectLevel;
})();

//module.exports = QRCodep;
;'use strict';
/**
 * @fileoverview
 *
